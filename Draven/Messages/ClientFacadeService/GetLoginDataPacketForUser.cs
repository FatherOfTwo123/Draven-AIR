...
namespace Draven.Messages.ClientFacadeService
{
    ...
    class GetLoginDataPacketForUser : IMessage
    {
        public RemotingMessageReceivedEventArgs HandleMessage(object sender, RemotingMessageReceivedEventArgs e)
        {
            ...
            packet.ClientSystemStates.Json = packet.ClientSystemStates.Json
                .Replace("\"itemSetServiceEnabled\":true", "\"itemSetServiceEnabled\":false");
